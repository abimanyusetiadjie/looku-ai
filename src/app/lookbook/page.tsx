...
export default function LookbookPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF8F5] pb-24 md:pb-0">
      ...
      <header className="sticky top-0 z-40 bg-[#FAF8F5]/95 backdrop-blur-md border-b border-[#E8DFD1]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="font-serif font-bold text-base sm:text-xl text-[#181A18] leading-tight">
                Lookbook Tropis Nusantara
              </h1>
            </div>
          </div>
          ...
          <Link
            href="/studio"
            className="py-1.5 px-3 sm:py-2 sm:px-4 rounded-xl bg-charcoal-900 hover:bg-terracotta-500 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-1.5 shadow-xs"
          >
            <Sparkles className="w-3.5 h-3.5 text-terracotta-400" />
            <span>Ke Studio OOTD</span>
          </Link>
        </div>
      </header>

      {/* Main Content Area */}
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 w-full space-y-12">
